...
export const personalityQuestions: Question[] = [
  ...
  {
    id: 'photoSharing',
    question: '연인과 함께한 사진 (선택시 5포인트 팅)',
  ...
  {
    id: 'idealDay',
    question: '연인과의 이상적인 하루는 (선택시 5포인트 팅)',
  ...
  {
    id: 'attraction',
    question: '연인에게 주로 끌리는 모습은 (선택시 5포인트 팅)',
  ...
  },
  {
    ...
    question: '연인이 내 친구들과 (선택시 5포인트 팅)',
